...
I descrittori 0, 1 e 2 hanno i ruoli standard di ingresso, risultati e diagnosi. Lo scenario illustrato usa tre aperture distinte verso il terminale: sola lettura per 0, sola scrittura per 1 e 2. Ogni apertura ha un riquadro e frecce proprie; una nota precisa che si tratta dello scenario scelto. La revisione evita di introdurre la duplicazione dei descrittori prima che gli studenti abbiano compreso le aperture indipendenti. Le altre aperture usano 3 e 4, mentre 5 è libero. La dispensa chiarisce la regola del numero libero più basso, il riuso dopo close e le redirezioni. I pannelli inferiori distinguono il controllo dei permessi all'apertura dalla verifica del descrittore e della modalità durante l'uso. Le frecce indicano riferimenti e le posizioni sono illustrative.
...
La spiegazione collegata distingue i numeri locali alle tabelle dei processi dalle aperture indipendenti dello stesso file. La traccia di lettura mantiene separate le posizioni di A e B; l’esempio di scrittura rende visibile che i dati sono comuni. La chiusura libera la voce del processo chiamante senza chiudere l’apertura indipendente dell’altro processo. Le risposte alle domande sono consultabili in un pannello espandibile.
